<footer>
                    ...
                    <div class="col-md-10">
                        <div class="row row-cols">
                            ...
                            <div class="col-md-4 col-links hidden-xs">
                                <h4>Links</h4>
                                <ul class="list-unstyled">
                                    <li><a href="#"><i class="fa fa-angle-right">Tickets</a></i>
                                    </li>
                                    <li>
                                        <a href="#"><i class="fa fa-angle-right">News</a></i>
                                    </li>
                                    <li>
                                        <a href="#"><i class="fa fa-angle-right">Schedule</a></i>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-md-4 col-get-in-touch">
                                ...
                                <address class="hidden-xs">
                                    <i class="fa fa-map-marker"></i><span> E. South Street, Suite 510<br/>Orlando, FL 32801</span>
                                </address>
    ...
    <!--para poder usar o javascrip do bootstrap-->
